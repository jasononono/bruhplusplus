...
keyboard.assign(p.K_LEFT, TextEditor.cursor_left)
keyboard.assign(p.K_RIGHT, TextEditor.cursor_right)
keyboard.assign(p.K_DOWN, TextEditor.cursor_down)
keyboard.assign(p.K_UP, TextEditor.cursor_up)
